...
export const ControlPanelObjectTab = () => {
  ...
  const resetObjectPosition = () => {
    setObjectPosition(object.defaultsInScene.position);
  };
  const resetObjectRotation = () => {
    setObjectRotation(object.defaultsInScene.rotation);
  };
  const resetObjectScale = () => {
    setObjectScale(object.defaultsInScene.scale);
  };
    ...
    <ControlPanelTabSection>
      <Tabs defaultValue="model" className="w-full ">
        ...
        <TabsContent value="model">
          <ObjectModelSection
            selectedModelId={object.data.model.modelId}
        ...
        <TabsContent value="scale">
          <ObjectScaleSection
            objectScale={
              object.data.inScene.scale || object.defaultsInScene.scale
            }
