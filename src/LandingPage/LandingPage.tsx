...
import grid from "../assets/gridSVG.svg";
    ...
    <div className="flex flex-col mx-1 md:mx-8 mt-8 relative">
      ...
      <div className="">
        <div className="px-8 pt-8">
          ...
          <div className="mt-8">
            <Button variant={"default"} onClick={() => navigate("/journey")}>
              Begin the journey
            </Button>
        ...
        <div className="flex gap-2 md:gap-3 mt-32 items-end flex-wrap justify-center md:justify-start">
          <div className="w-60">
            <Card className="relative">
              <CardContent className="p-2">
                <img src={boxRotateAboveY} className="rounded-2xl" />
              </CardContent>
          ...
          <div className="w-60">
            <Card className="relative">
              <CardContent className="p-2">
                <img src={cylinderRotateAboveY} className="rounded-2xl" />
              </CardContent>
              <CardFooter className="flex justify-between px-2 pb-2 items-start">
                <p className="text-muted-foreground text-sm ml-2">
                  Rotating a cylinder.
                ...
                <Button
                  onClick={() => navigate("/viewer/cylinder/above/y")}
                  variant={"secondary"}
                >
                  Try
                </Button>
      ...
      <div className="w-full px-8 pt-[16rem] mt-[8rem] h-fit ">
        ...
        <Typography>
          Try to draw what you see, and start making observations. Go through
          all the rotations.
        </Typography>
        <Typography>
          Its recommended that you go through a level twice. First trying to
          predict how it will look like. Then drawing the actual version, then
          try to compare
        </Typography>
        <Typography>
        ...
        <Typography>
          Tips: don't try to go through the entire catalogue as quick as
          possible, take your time on the earlier challenges till you can draw
          it naturally.
        </Typography>
      </div>
